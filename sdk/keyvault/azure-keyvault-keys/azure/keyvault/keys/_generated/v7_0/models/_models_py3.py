...
class Action(Model):
    ...
    :type action_type: str or ~v7_0.models.ActionType
    """
...
class CertificateAttributes(Attributes):
    ...
    :vartype recovery_level: str or ~v7_0.models.DeletionRecoveryLevel
    """
...
class CertificateBundle(Model):
    ...
    :vartype policy: ~v7_0.models.CertificatePolicy
    ...
    :type attributes: ~v7_0.models.CertificateAttributes
...
class CertificateOperation(Model):
    ...
    :param issuer_parameters: Parameters for the issuer of the X509 component
     of a certificate.
    :type issuer_parameters: ~v7_0.models.IssuerParameters
...
class Contacts(Model):
    ...
    :type contact_list: list[~v7_0.models.Contact]
    """
...
class KeyBundle(Model):
    ...
    :type attributes: ~v7_0.models.KeyAttributes
    :param tags: Application specific metadata in the form of key-value pairs.
    :type tags: dict[str, str]
...
class SasDefinitionBundle(Model):
    ...
    :vartype sas_type: str or ~v7_0.models.SasTokenType
    ...
    :vartype attributes: ~v7_0.models.SasDefinitionAttributes
...
class SecretBundle(Model):
    ...
    :type attributes: ~v7_0.models.SecretAttributes
    :param tags: Application specific metadata in the form of key-value pairs.
    :type tags: dict[str, str]
...
class StorageAccountItem(Model):
    ...
    :vartype attributes: ~v7_0.models.StorageAccountAttributes
    :ivar tags: Application specific metadata in the form of key-value pairs.
    :vartype tags: dict[str, str]
    """
...
class Error(Model):
    ...
    :vartype message: str
    :ivar inner_error:
    :vartype inner_error: ~v7_0.models.Error
    """
...
class JsonWebKey(Model):
    ...
    :param crv: Elliptic curve name. For valid values, see
     ...
     'P-256K'
    :type crv: str or ~v7_0.models.JsonWebKeyCurveName
...
class KeyProperties(Model):
    ...
    :param key_type: The type of key pair to be used for the certificate.
     Possible values include: 'EC', 'EC-HSM', 'RSA', 'RSA-HSM', 'oct'
    :type key_type: str or ~v7_0.models.JsonWebKeyType
    :param key_size: The key size in bits. For example: 2048, 3072, or 4096
     for RSA.
    :type key_size: int
...
class KeyVaultError(Model):
    ...
    :ivar error:
    :vartype error: ~v7_0.models.Error
    """
...
class LifetimeAction(Model):
    ...
    :type trigger: ~v7_0.models.Trigger
    :param action: The action that will be executed.
    :type action: ~v7_0.models.Action
    """
...
class OrganizationDetails(Model):
    ...
    :type admin_details: list[~v7_0.models.AdministratorDetails]
    """
...
class StorageAccountCreateParameters(Model):
    ...
    :type storage_account_attributes: ~v7_0.models.StorageAccountAttributes
    :param tags: Application specific metadata in the form of key-value pairs.
    :type tags: dict[str, str]
    """
...
class X509CertificateProperties(Model):
    ...
    :type subject_alternative_names: ~v7_0.models.SubjectAlternativeNames
    :param key_usage: List of key usages.
    :type key_usage: list[str or ~v7_0.models.KeyUsageType]
